...
- 工业、侦察和一个主力作战任务已经可以并行并按单位仲裁冲突；尚未支持多个独立主力战斗编队、任意任务图和资源预留优先级；
